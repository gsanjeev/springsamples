package com.laxtech.example.sparklr.config;
...
import com.laxtech.example.sparklr.PhotoInfo;
import com.laxtech.example.sparklr.PhotoService;
import com.laxtech.example.sparklr.impl.PhotoServiceImpl;
import com.laxtech.example.sparklr.mvc.AccessConfirmationController;
import com.laxtech.example.sparklr.mvc.AdminController;
import com.laxtech.example.sparklr.mvc.PhotoController;
import com.laxtech.example.sparklr.mvc.PhotoServiceUserController;
import com.laxtech.example.sparklr.oauth.SparklrUserApprovalHandler;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	private PhotoInfo createPhoto(String id, String userId) {
		...
		photo.setResourceURL("/com/laxtech/example/sparklr/impl/resources/" + photo.getName());
		return photo;
	}
